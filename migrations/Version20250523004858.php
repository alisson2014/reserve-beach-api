...
final class Version20250523004858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE courts (id INT AUTO_INCREMENT NOT NULL, court_type_id INT NOT NULL, name VARCHAR(50) NOT NULL, description VARCHAR(150) NOT NULL, scheduling_fee NUMERIC(10, 2) NOT NULL, capacity SMALLINT NOT NULL, active TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_AD0B4C2F5E237E06 (name), INDEX IDX_AD0B4C2FE22B8821 (court_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
