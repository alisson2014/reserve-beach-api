 ...
 */
final class Version20250518193144 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Migration para criar a tabela de usuários (clientes e administradores).';
    }
