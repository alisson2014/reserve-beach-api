...
class CourtTypeController extends AbstractController
{
    ...
    #[Route('/api/court_types/{id}', name: 'court_types_show', methods: ['GET'])]
    ...
    public function create(Request $request, ValidatorInterface $validator): JsonResponse
    {
        ...
        try {
            ...
            return $this->json([
                'status' => false,
                'errors' => 'Erro ao cadastrar tipo de quadra' . $ex->getMessage(),
    ...
    #[Route('/api/court_types/{id}', name: 'court_type_update', methods: ['PUT'])]
    #[IsGranted('ROLE_ADMIN')]
    public function update(int $id, Request $request, ValidatorInterface $validator): JsonResponse
    {
        ...
        try {
            ...
            return $this->json([
                'status' => false,
                'errors' => 'Erro ao atualizar tipo de quadra' . $ex->getMessage(),
            ], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    ...
    #[Route('/api/court_types/{id}', name: 'court_type_delete', methods: ['DELETE'])]
    #[IsGranted('ROLE_ADMIN')]
    public function delete(int $id): JsonResponse
    {
        ...
        try {
            ...
            return $this->json([
                'status' => false,
                'errors' => 'Erro ao remover tipo de quadra' . $ex->getMessage(),
            ], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
